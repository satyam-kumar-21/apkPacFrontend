...
const ActionGameSection = () => {
  ...
  const actionApps = apps.filter((app) => {
    ...
    if (app.category && app.category.toLowerCase() === "action") {
      isAction = true;
    }
    return isAction;
  });
  ...
  return (
    <section className="w-full max-w-6xl mx-auto mt-10 mb-8 px-4">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Action</h2>
        <Link
          to="/apps/action"
...
export default ActionGameSection;
