...
const FoodAppsSection = () => {
  ...
  // Filter apps for description1 category 'Food'
  ...
  return (
    <section className="w-full max-w-6xl mx-auto mt-10 mb-8 px-4">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Food</h2>
        <Link
          to="/apps/food"
          className="bg-gradient-to-r from-green-500 to-yellow-500 text-white px-5 py-2 rounded-lg font-bold shadow hover:scale-105 transition"
        >
          Show All
        </Link>
      </div>
...
export default FoodAppsSection;
