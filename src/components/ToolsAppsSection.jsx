...
const ToolsAppsSection = () => {
  ...
  const limit = 9;
  const { data, isLoading, isFetching } = useGetAppsQuery({ category: "Tools", limit, skip: page * limit });
  ...
  return (
    <section className="w-full max-w-6xl mx-auto mt-10 mb-8 px-4">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Tools</h2>
        <Link
          to="/apps/tools"
...
export default ToolsAppsSection;
